...
Tu'urna is a tabletop role-playing game designed to enable a group of players
to engage in cooperative imaginative storytelling. The rules of Tu'urna are
designed to provide enough of a shared framework to allow the players to
express diverse fantastical characters and stories in a common system.

The first and most important rule of Tu'urna is that it is meant to be fun, and
all other rules are essentially advice about how to achieve that end. The
...
(intro:how-to-play:how-to-read)=
## How to Read these Rules

The rules for Tu'urna contained in this document are not intended to be a
...
swords should be considered more authoritative for a sword than a conflicting
